...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Web Profil Desa Bantan Tua, Kec. Merigi Sakti, Kab. Bengkulu Tengah, Indonesia">
    <meta name="author" content="M. Raka Maulana A.">

    <title>Desaku - Desa Bantan Tua</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Desa Bantan Tua</a>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          ...
          <div class="intro-heading text-uppercase">Desa Bantan Tua</div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Desa Bantan Tua, Kec. Merigi Sakti, Kab. Bengkulu Tengah</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
              ...
              <li>
                ...
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    <h4>2012</h4>
                    <h4 class="subheading">Pemekaran</h4>
                  </div>
                  <div class="timeline-body">
                    <p class="text-muted">Desa Bantan Tua merupakan desa baru hasil dari pemekaran Desa Rajak Besi.</p>
                  </div>
                </div>
              </li>              
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              <h4>Wilayah</h4>
              <p class="text-muted">Desa Bantan Tua</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
          ...
          <div class="col-md-4">
            <ul class="list-inline quicklinks">
              <li class="list-inline-item">
                <a href="https://github.com/rmalan/desa">KKN UNIB Periode 85 Tahun 2018</a>
              </li>              
            </ul>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <p class="item-intro text-muted">Desa Bantan Tua</p>
                  <img class="img-fluid d-block mx-auto" src="img/profil/wilayah-full.png" alt="">
                  <p>Desa Bantan Tua merupakan salah satu desa yang ada di Kecamatan Merigi Sakti Kabupaten Bengkulu Tengah dengan luas wilayah 1700 ha. Sebelah utara berbatasan dengan Desa Rajak Besi, sebelah selatan berbatasan dengan Desa Taba Gemantung, sebelah barat berbatasan dengan Desa Keroya, dan sebelah timur berbatasan dengan Desa Komering.</p>
                  <!--
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <p>Potensi yang dimilliki oleh adalah dalam bidang pertanian dan bidang peternakan. Pertanian dan perkebunan yang ada Desa Bantan Tua sesuai dengan lahan di sini yang terbilang cukup baik. Beberapa komoditas yang ditanam adalah sawit, kopi, dan lada. Semua komoditas tersebut dipilih dengan bibit yang unggul.</p>
                  <button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fa fa-times"></i>
                    Tutup</button>
                </div>
              ...
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <p class="text-left"><b>VISI :</b>
                    <br/>Visi Desa Bantan Tua adalah "MELAYANI MASYARAKAT KHUSUSNYA DESA Bantan Tua DENGAN SEBAIK-BAIKNYA"
                    <br/><br/><b>MISI :</b>
                    ...
                    <br/>&emsp;2.&ensp;MEMAKMURKAN MASYARAKAT DESA Bantan Tua
                  </p>
                  <button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fa fa-times"></i>
                    Tutup</button>
